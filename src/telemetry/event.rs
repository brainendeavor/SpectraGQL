...
pub use crate::core::types::{EventStatus, OperationOutcome};
use crate::protocol::{PayloadType, RequestInfo, ResponseInfo, SanitizedPayload};
...
mod tests {
    ...
    fn test_terminal_event_sanitization() {
        ...
        let gql_info = crate::protocol::GraphQLRequestInfo::new(
