...
use crate::protocol::{GraphQLRequestInfo, HttpRequestInfo, PayloadType};
...
impl RequestInfo {
    ...
    pub fn sanitize(&mut self) {
        let sanitizer = crate::interceptors::Sanitizer::default_sanitizer();
    ...
    pub fn into_sanitized(mut self) -> crate::protocol::SanitizedPayload<Self> {
        self.sanitize();
        crate::protocol::SanitizedPayload::new_unchecked(self)
    }
}
